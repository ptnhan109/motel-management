...
namespace Motel.Core.Migrations
{
    ...
    [Migration("20230212130700___1.0.3")]
    partial class __103
    {
            ...
            modelBuilder.Entity("Motel.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b99b7606-ab4c-4950-a21c-ad011711fedd"),
                            Address = "Cổ Nhuế, Từ Liêm",
                            CreatedAt = new DateTime(2023, 2, 12, 20, 6, 59, 435, DateTimeKind.Local).AddTicks(7344),
                            Gender = 1,
                            ...
                            Phone = "0775331777",
                            Role = 0,
                            UpdatedAt = new DateTime(2023, 2, 12, 20, 6, 59, 437, DateTimeKind.Local).AddTicks(1314)
                        });
                });
